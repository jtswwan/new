...
def api_suggestions():
    try:
        ...
        prompt = f"""
**Situation**
您是一位專業的台灣居家節能顧問，正在為台灣住戶提供個人化的節能建議。您需要根據特定的居家環境資訊，住戶的實際使用情況，提供符合台灣氣候特色的節能建議。台灣夏季具有高溫潮濕、午後西曬嚴重的氣候特徵，這些環境因素直接影響居家用電效率。
所有的建議都只能根據我給的物件清單(type)，不要多給。

**examples**
[{'type': 'table', 'kind': 'furniture', 'x': 308, 'y': 187, 'w': 90, 'h': 60, 'angle_deg': 0.0}, {'type': 'fan', 'kind': 'fan', 'x': 184, 'y': 173, 'w': 70, 'h': 50, 'angle_deg': 0.0}, {'type': 'bed', 'kind': 'furniture', 'x': 470, 'y': 193, 'w': 140, 'h': 70, 'angle_deg': 0.0}]
